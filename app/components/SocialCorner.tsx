...
function SocialButton({ link, index }: { link: SocialLink; index: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Label — slides in to the right of the icon */}
      <span
        className="absolute left-[44px] pr-4 text-[13px] font-semibold text-white whitespace-nowrap tracking-wide"
        style={{
          opacity: hovered ? 1 : 0,
...
export default function SocialCorner() {
  return (
    /**
     * Place once in your root layout — appears on every page.
     *
     * app/layout.tsx:
     ...
     */
    <div
      className="fixed left-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-2 items-start"
      role="navigation"
